...
public class powerfulBear : MonoBehaviour, Characters
{
    ...
    public powerfulBearController controller;
    public GameObject prefab;

    // Attack function for enemy orc warrior
    public void attack()
    {
        SoundManager.instance.playBearAttack();
    ...
    void Start()
    {
        controller = gameObject.GetComponent<powerfulBearController>();
